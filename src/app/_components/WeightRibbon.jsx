...
export default function WeightRibbon({
  ...
  return (
    <div className="flex flex-wrap justify-center items-center pt-12">
      <div>
        <div className="flex flex-col justify-center items-center text-white bg-PrimaryBlue border-[50px] border-transparent border-r-[#2e2f2e] border-l-[#2e2f2e] w-[100vw] md:w-[70vw] h-[15vh] hover:bg-SecondaryBlue">
